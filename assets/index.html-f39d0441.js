import{_ as e,o as n,c as i,e as s}from"./app-45377375.js";const d={},l=s(`<h2 id="_1、前言" tabindex="-1"><a class="header-anchor" href="#_1、前言" aria-hidden="true">#</a> 1、前言</h2><p>本篇文章主要是记录在日常工作中使用 TS 的一些常用方法以及类型定义。</p><h2 id="_2、ts-常用关键字" tabindex="-1"><a class="header-anchor" href="#_2、ts-常用关键字" aria-hidden="true">#</a> 2、TS 常用关键字</h2><p>1.keyof 操作符使用 keyof 用于返回对应类型所有 Key 的联合类型</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>interface IUser {
  name: string;
  age: number;
  number: number;
}
