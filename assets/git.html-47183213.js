import{_ as s,o as d,c as a,e as n,a as e,b as i}from"./app-4b62f06d.js";const t={},l=n(`<h2 id="_1、remote" tabindex="-1"><a class="header-anchor" href="#_1、remote" aria-hidden="true">#</a> 1、remote</h2><p>绑定、删除远程仓库地址</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1、列出所有 remote 远程主机
   git remote
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-git-rm-cached" tabindex="-1"><a class="header-anchor" href="#_9-git-rm-cached" aria-hidden="true">#</a> 9.git rm --cached</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>移除缓存中跟踪的目录，用于以前跟踪，现在又需要忽略的文件。
git rm --cached &lt;文件目录&gt;
ps: git rm -r --cached src/api/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),u=[l,r,c,m,v];function o(b,h){return d(),a("div",null,u)}const x=s(t,[["render",o],["__file","git.html.vue"]]);export{x as default};
